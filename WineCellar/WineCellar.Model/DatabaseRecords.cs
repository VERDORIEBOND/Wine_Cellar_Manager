...
public record WineRecord(int Id, string Name, decimal Buy, decimal Sell, int TypeId, string Type, int CountryId, string Country, string Picture, int Year, int Content, decimal Alcohol, int Rating, string Description);
